...
export default function MealBuilder({ open, onOpenChange, mealToEdit }: MealBuilderProps) {
  ...
  const handleSave = () => {
    ...
    if (mealToEdit) {
      updateMeal({ id: mealToAncora una volta, mi scuso per l'errore. La correzione precedente era chiaramente sbagliata. Ho ripristinato e corretto la struttura del layout per garantire che la sezione degli ingredienti sia visibile e scorrevole.
